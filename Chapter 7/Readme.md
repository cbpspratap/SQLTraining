...
We will use Sakila database in this chapter, if you dont have sakila db available in your db then click [here](https://downloads.mysql.com/docs/sakila-db.zip) to download and follow the below steps to setup the db in your Mysql Server. [Link](https://downloads.mysql.com/docs/sakila-db.zip)
