...
During the training I will follow MySQL syntax and you can follow along by using MySQL flavor DBMS (*on your personal computer or you can use [db-fiddle](https://db-fiddle.com/) to practice*).
...
## [Chapter 2: SQL Commands](https://github.com/cbpspratap/SQLTraining/blob/main/Chapter%202/Readme.md)
...
## [Chapter 3: Run SQL Statements](https://github.com/cbpspratap/SQLTraining/tree/main/Chapter%203)
